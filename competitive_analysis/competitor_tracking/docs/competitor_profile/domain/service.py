...
SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['market_analysis', 'competitive_observation', 'strategic_risk_signal'], 'action_targets': {'create': None, 'update': None, 'review': None, 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}
