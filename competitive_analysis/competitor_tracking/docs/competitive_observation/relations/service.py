"""Relation service seed for competitive_observation."""
...
RELATED_DOCS = [{'doc_id': 'competitor_profile', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'market_analysis', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'strategic_risk_signal', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'competitor identity'}, {'description': 'segment from competitor_profile'}]
