...
SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['competitor_profile', 'market_analysis', 'strategic_risk_signal'], 'action_targets': {'record': None, 'review': 'reviewed', 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}
