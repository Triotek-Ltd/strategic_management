"""Relation service seed for market_analysis."""
...
RELATED_DOCS = [{'doc_id': 'competitor_profile', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'competitive_observation', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'strategic_risk_signal', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []
