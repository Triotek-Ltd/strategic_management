"""Action handler seed for strategic_risk_signal:archive."""
...
ACTION_ID = "archive"
ACTION_RULE: dict[str, Any] = {'allowed_in_states': ['raised', 'reviewed', 'mitigating', 'escalated'], 'transitions_to': 'archived'}
