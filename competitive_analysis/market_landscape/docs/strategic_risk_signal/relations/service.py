"""Relation service seed for strategic_risk_signal."""
...
RELATED_DOCS = [{'doc_id': 'market_analysis', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'competitive_observation', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'execution_issue_case', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'source context from market_analysis or competitive_observation'}]
