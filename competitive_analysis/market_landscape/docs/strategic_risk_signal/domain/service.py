...
SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['market_analysis', 'competitive_observation', 'execution_issue_case'], 'action_targets': {'create': None, 'assign': None, 'review': 'reviewed', 'mitigate': None, 'escalate': 'escalated', 'close': 'closed', 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}
