...
CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'owner': 'actor_reference', 'target_date': 'schedule_marker', 'goal_status': 'status_flag'}, 'search_fields': ['title', 'reference_no', 'description', 'goal_code', 'linked_plan', 'owner'], 'list_columns': ['title', 'reference_no', 'workflow_state', 'modified'], 'initial_state': 'proposed', 'lifecycle_states': ['proposed', 'active', 'at_risk', 'achieved', 'deferred', 'closed', 'archived'], 'terminal_states': ['closed', 'archived'], 'action_targets': {'create': None, 'assign': None, 'review': None, 'activate': 'active', 'close': 'closed', 'defer': None, 'archive': 'archived'}}
