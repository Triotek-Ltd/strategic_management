"""Action handler seed for strategic_goal:assign."""
...
ACTION_ID = "assign"
ACTION_RULE: dict[str, Any] = {'allowed_in_states': ['proposed', 'active', 'at_risk', 'achieved', 'deferred'], 'transitions_to': None}

STATE_FIELD = 'workflow_state'
WORKFLOW_HINTS = {}

ACTION_CONTRACT: dict[str, Any] = {'rule': {'allowed_in_states': ['proposed', 'active', 'at_risk', 'achieved', 'deferred'], 'transitions_to': None}, 'requires_action_comment': False, 'requires_reason_for_change': False, 'requires_evidence': False, 'is_disposition_action': False, 'creates_submission_snapshot': False, 'creates_official_copy': False, 'requires_signature': False}
