"""Relation service seed for strategic_goal."""
...
RELATED_DOCS = [{'doc_id': 'strategic_plan', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'planning_cycle', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'initiative_portfolio', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'execution_plan', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'plan title'}, {'description': 'theme from strategic_plan'}]
