"""Relation service seed for strategic_plan."""
...
RELATED_DOCS = [{'doc_id': 'planning_cycle', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'strategic_goal', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'initiative_portfolio', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'strategy_status_report', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []
