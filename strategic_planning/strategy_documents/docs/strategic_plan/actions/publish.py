"""Action handler seed for strategic_plan:publish."""
...
ACTION_ID = "publish"
ACTION_RULE: dict[str, Any] = {'allowed_in_states': ['draft', 'reviewed', 'approved', 'active', 'superseded'], 'transitions_to': None}
