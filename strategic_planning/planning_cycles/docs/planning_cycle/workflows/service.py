"""Workflow service seed for planning_cycle."""
...
STATES = ['planned', 'active', 'closed', 'archived']
...
RECORD_CONTRACT = {'doc_kind': 'event', 'supports_attachments': True, 'supports_comments': True, 'supports_activity_log': True, 'supports_assignments': True, 'is_submittable': False, 'supports_submission_snapshot': True, 'supports_official_outputs': True, 'supports_evidence_pack': True, 'supports_signoff': False}
