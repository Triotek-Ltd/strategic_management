"""Relation service seed for planning_cycle."""
...
RELATED_DOCS = [{'doc_id': 'strategic_plan', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'strategic_goal', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'strategic horizon defaults from strategic_plan'}]
