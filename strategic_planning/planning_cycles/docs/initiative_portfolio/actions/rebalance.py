"""Action handler seed for initiative_portfolio:rebalance."""
...
ACTION_ID = "rebalance"
ACTION_RULE: dict[str, Any] = {'allowed_in_states': ['draft', 'approved', 'active', 'rebalanced'], 'transitions_to': None}
...
def handle_rebalance(payload: dict, context: dict | None = None) -> dict:
    context = context or {}
