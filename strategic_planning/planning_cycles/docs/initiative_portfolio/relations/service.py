"""Relation service seed for initiative_portfolio."""
...
RELATED_DOCS = [{'doc_id': 'strategic_plan', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'strategic_goal', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'growth_initiative', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'execution_plan', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'strategic priorities from strategic_plan'}]
