"""Relation service seed for revenue_model."""
...
RELATED_DOCS = [{'doc_id': 'business_model_record', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'value_proposition', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'model_change_case', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'linked customer scope'}, {'description': 'channel summary from business_model_record'}]
