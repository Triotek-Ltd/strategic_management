"""Relation service seed for business_model_record."""
...
RELATED_DOCS = [{'doc_id': 'value_proposition', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'revenue_model', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'model_change_case', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []
