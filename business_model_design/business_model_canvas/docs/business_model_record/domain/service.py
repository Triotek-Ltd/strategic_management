...
SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['value_proposition', 'revenue_model', 'model_change_case'], 'action_targets': {'create': None, 'update': None, 'review': None, 'approve': 'approved', 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}
