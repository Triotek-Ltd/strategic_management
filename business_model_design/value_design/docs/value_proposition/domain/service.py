...
SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['business_model_record', 'revenue_model'], 'action_targets': {'create': None, 'update': None, 'review': 'reviewed', 'publish': None, 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}
