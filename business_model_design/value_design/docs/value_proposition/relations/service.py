"""Relation service seed for value_proposition."""
...
RELATED_DOCS = [{'doc_id': 'business_model_record', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'revenue_model', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'customer scope from business_model_record'}]
