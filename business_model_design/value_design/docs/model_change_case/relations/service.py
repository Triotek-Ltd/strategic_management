"""Relation service seed for model_change_case."""
...
RELATED_DOCS = [{'doc_id': 'business_model_record', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'value_proposition', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'revenue_model', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'current model details from business_model_record'}]
