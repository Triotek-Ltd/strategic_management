...
ACTION_CONTRACT: dict[str, Any] = {'rule': {'allowed_in_states': ['proposed', 'in_review', 'approved', 'rejected'], 'transitions_to': 'in_review'}, 'requires_action_comment': False, 'requires_reason_for_change': False, 'requires_evidence': False, 'is_disposition_action': False, 'creates_submission_snapshot': True, 'creates_official_copy': False, 'requires_signature': False}
