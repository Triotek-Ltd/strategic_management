"""Action handler seed for execution_plan:activate."""
...
ACTION_CONTRACT: dict[str, Any] = {'rule': {'allowed_in_states': ['draft'], 'transitions_to': 'active'}, 'requires_action_comment': False, 'requires_reason_for_change': False, 'requires_evidence': False, 'is_disposition_action': False, 'creates_submission_snapshot': False, 'creates_official_copy': False, 'requires_signature': False}
