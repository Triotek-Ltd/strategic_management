"""Action handler seed for execution_plan:archive."""
...
ACTION_ID = "archive"
ACTION_RULE: dict[str, Any] = {'allowed_in_states': ['draft', 'approved', 'active', 'revised', 'completed'], 'transitions_to': 'archived'}
