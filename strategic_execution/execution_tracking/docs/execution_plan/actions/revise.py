"""Action handler seed for execution_plan:revise."""
...
ACTION_ID = "revise"
ACTION_RULE: dict[str, Any] = {'allowed_in_states': ['draft', 'approved', 'active', 'revised', 'completed'], 'transitions_to': None}
...
def handle_revise(payload: dict, context: dict | None = None) -> dict:
    context = context or {}
