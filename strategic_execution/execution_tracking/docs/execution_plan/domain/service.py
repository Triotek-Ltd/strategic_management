...
SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['growth_initiative', 'execution_milestone', 'strategy_status_report', 'execution_issue_case'], 'action_targets': {'create': None, 'update': None, 'review': None, 'approve': 'approved', 'activate': 'active', 'close': 'closed', 'revise': None, 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}
