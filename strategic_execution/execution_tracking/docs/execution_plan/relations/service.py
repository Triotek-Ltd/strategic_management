"""Relation service seed for execution_plan."""
...
RELATED_DOCS = [{'doc_id': 'growth_initiative', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'execution_milestone', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'strategy_status_report', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'execution_issue_case', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'strategic priorities from growth_initiative or corporate_strategy_record'}]
