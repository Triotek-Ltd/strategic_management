"""Relation service seed for execution_milestone."""
...
RELATED_DOCS = [{'doc_id': 'execution_plan', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'execution_issue_case', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'plan owner'}, {'description': 'timeline from execution_plan'}]
