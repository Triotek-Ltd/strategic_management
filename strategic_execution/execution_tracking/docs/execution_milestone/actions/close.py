"""Action handler seed for execution_milestone:close."""
...
ACTION_ID = "close"
ACTION_RULE: dict[str, Any] = {'allowed_in_states': ['planned', 'active', 'delayed', 'completed'], 'transitions_to': 'closed'}
