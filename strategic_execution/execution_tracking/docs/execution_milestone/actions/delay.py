"""Action handler seed for execution_milestone:delay."""
...
ACTION_ID = "delay"
ACTION_RULE: dict[str, Any] = {'allowed_in_states': ['planned', 'active', 'delayed', 'completed'], 'transitions_to': None}
...
def handle_delay(payload: dict, context: dict | None = None) -> dict:
    context = context or {}
