"""Business-domain service seed for Execution Milestone."""
...
SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['execution_plan', 'execution_issue_case'], 'action_targets': {'create': None, 'assign': None, 'track': None, 'delay': None, 'close': 'closed', 'archive': 'archived'}, 'action_side_effects_file': None}
