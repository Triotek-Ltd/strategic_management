"""Action handler seed for execution_issue_case:assign."""
...
ACTION_ID = "assign"
ACTION_RULE: dict[str, Any] = {'allowed_in_states': ['opened', 'in_progress', 'mitigating', 'escalated'], 'transitions_to': 'in_progress'}
