"""Action handler seed for execution_issue_case:escalate."""
...
ACTION_ID = "escalate"
ACTION_RULE: dict[str, Any] = {'allowed_in_states': ['opened', 'in_progress', 'mitigating', 'escalated'], 'transitions_to': 'escalated'}
