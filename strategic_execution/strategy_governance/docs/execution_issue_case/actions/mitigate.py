"""Action handler seed for execution_issue_case:mitigate."""
...
ACTION_ID = "mitigate"
ACTION_RULE: dict[str, Any] = {'allowed_in_states': ['opened', 'in_progress', 'mitigating', 'escalated'], 'transitions_to': None}
