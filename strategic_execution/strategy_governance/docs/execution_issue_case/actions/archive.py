"""Action handler seed for execution_issue_case:archive."""
...
ACTION_ID = "archive"
ACTION_RULE: dict[str, Any] = {'allowed_in_states': ['opened', 'in_progress', 'mitigating', 'escalated'], 'transitions_to': 'archived'}
