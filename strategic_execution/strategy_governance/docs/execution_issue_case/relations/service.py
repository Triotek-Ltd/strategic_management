"""Relation service seed for execution_issue_case."""
...
RELATED_DOCS = [{'doc_id': 'execution_plan', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'execution_milestone', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'strategic_risk_signal', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'linked plan or milestone context from source docs'}]
