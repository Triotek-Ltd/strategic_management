"""Workflow service seed for execution_issue_case."""
...
STATES = ['opened', 'in_progress', 'mitigating', 'escalated', 'closed', 'archived']
TERMINAL_STATES = ['closed', 'archived']
ACTION_RULES: dict[str, dict[str, Any]] = {'create': {'allowed_in_states': ['opened', 'in_progress', 'mitigating', 'escalated'], 'transitions_to': None}, 'assign': {'allowed_in_states': ['opened', 'in_progress', 'mitigating', 'escalated'], 'transitions_to': 'in_progress'}, 'mitigate': {'allowed_in_states': ['opened', 'in_progress', 'mitigating', 'escalated'], 'transitions_to': None}, 'escalate': {'allowed_in_states': ['opened', 'in_progress', 'mitigating', 'escalated'], 'transitions_to': 'escalated'}, 'close': {'allowed_in_states': ['opened', 'in_progress', 'mitigating', 'escalated'], 'transitions_to': 'closed'}, 'archive': {'allowed_in_states': ['opened', 'in_progress', 'mitigating', 'escalated'], 'transitions_to': 'archived'}}
...
RECORD_CONTRACT = {'doc_kind': 'workflow_case', 'supports_attachments': True, 'supports_comments': True, 'supports_activity_log': True, 'supports_assignments': True, 'is_submittable': False, 'supports_submission_snapshot': True, 'supports_official_outputs': True, 'supports_evidence_pack': True, 'supports_signoff': False}
