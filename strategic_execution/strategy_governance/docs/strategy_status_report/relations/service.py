"""Relation service seed for strategy_status_report."""
...
RELATED_DOCS = [{'doc_id': 'execution_plan', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'execution_milestone', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'execution_issue_case', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'plan or strategy identity from linked records'}]
