"""Business-domain service seed for Strategy Status Report."""
...
SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['execution_plan', 'execution_milestone', 'execution_issue_case'], 'action_targets': {'create': None, 'review': 'reviewed', 'publish': 'published', 'archive': 'archived'}, 'action_side_effects_file': None}
