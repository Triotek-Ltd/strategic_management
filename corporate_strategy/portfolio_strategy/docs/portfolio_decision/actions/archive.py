"""Action handler seed for portfolio_decision:archive."""
...
ACTION_ID = "archive"
ACTION_RULE: dict[str, Any] = {'allowed_in_states': ['proposed', 'reviewed', 'approved', 'rejected'], 'transitions_to': 'archived'}
