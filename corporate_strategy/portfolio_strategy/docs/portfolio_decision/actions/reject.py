"""Action handler seed for portfolio_decision:reject."""
...
ACTION_ID = "reject"
ACTION_RULE: dict[str, Any] = {'allowed_in_states': ['proposed', 'reviewed', 'approved', 'rejected'], 'transitions_to': 'rejected'}
