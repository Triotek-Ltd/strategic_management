"""Relation service seed for portfolio_decision."""
...
RELATED_DOCS = [{'doc_id': 'corporate_strategy_record', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'growth_initiative', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'strategy direction from corporate_strategy_record'}]
