"""Workflow service seed for portfolio_decision."""
...
STATES = ['proposed', 'reviewed', 'approved', 'rejected', 'closed', 'archived']
TERMINAL_STATES = ['closed', 'archived']
ACTION_RULES: dict[str, dict[str, Any]] = {'create': {'allowed_in_states': ['proposed', 'reviewed', 'approved', 'rejected'], 'transitions_to': None}, 'review': {'allowed_in_states': ['proposed', 'reviewed', 'approved', 'rejected'], 'transitions_to': 'reviewed'}, 'approve': {'allowed_in_states': ['proposed', 'reviewed', 'approved', 'rejected'], 'transitions_to': 'approved'}, 'reject': {'allowed_in_states': ['proposed', 'reviewed', 'approved', 'rejected'], 'transitions_to': 'rejected'}, 'close': {'allowed_in_states': ['proposed', 'reviewed', 'approved', 'rejected'], 'transitions_to': 'closed'}, 'archive': {'allowed_in_states': ['proposed', 'reviewed', 'approved', 'rejected'], 'transitions_to': 'archived'}}

STATE_FIELD = 'workflow_state'
WORKFLOW_HINTS = {}

RECORD_CONTRACT = {'doc_kind': 'transaction', 'supports_attachments': True, 'supports_comments': True, 'supports_activity_log': True, 'supports_assignments': True, 'is_submittable': False, 'supports_submission_snapshot': True, 'supports_official_outputs': True, 'supports_evidence_pack': True, 'supports_signoff': True}
