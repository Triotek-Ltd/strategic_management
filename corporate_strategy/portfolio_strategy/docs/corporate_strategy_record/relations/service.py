"""Relation service seed for corporate_strategy_record."""
...
RELATED_DOCS = [{'doc_id': 'growth_initiative', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'portfolio_decision', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'strategy_review_note', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []
