"""Business-domain service seed for Corporate Strategy Record."""
...
class DomainService:
    ...
    def after_action(
        ...
        if action_contract.get("requires_signature"):
            ...
            signer = payload.get("signature_name