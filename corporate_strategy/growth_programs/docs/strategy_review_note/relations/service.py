"""Relation service seed for strategy_review_note."""
...
RELATED_DOCS = [{'doc_id': 'corporate_strategy_record', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'growth_initiative', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'strategy_status_report', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'strategy or initiative identity from linked records'}]
