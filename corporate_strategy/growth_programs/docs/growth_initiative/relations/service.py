"""Relation service seed for growth_initiative."""
...
RELATED_DOCS = [{'doc_id': 'corporate_strategy_record', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'initiative_portfolio', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'execution_plan', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'priority domain'}, {'description': 'strategy title from corporate_strategy_record'}]
