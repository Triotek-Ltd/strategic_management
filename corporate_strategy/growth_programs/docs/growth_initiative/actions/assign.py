"""Action handler seed for growth_initiative:assign."""
...
ACTION_ID = "assign"
ACTION_RULE: dict[str, Any] = {'allowed_in_states': ['proposed', 'approved', 'active', 'completed', 'stopped'], 'transitions_to': None}
