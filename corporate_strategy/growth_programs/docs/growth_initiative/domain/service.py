...
CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'owner': 'actor_reference'}, 'search_fields': ['title', 'reference_no', 'description', 'initiative_code', 'linked_strategy', 'owner'], 'list_columns': ['title', 'reference_no', 'workflow_state', 'modified'], 'initial_state': 'proposed', 'lifecycle_states': ['proposed', 'approved', 'active', 'completed', 'stopped', 'closed', 'archived'], 'terminal_states': ['closed', 'archived'], 'action_targets': {'create': None, 'assign': None, 'approve': 'approved', 'activate': 'active', 'close': 'closed', 'stop': None, 'archive': 'archived'}}
